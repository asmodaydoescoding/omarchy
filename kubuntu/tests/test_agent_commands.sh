...
run_non_inline agy --prompt 'Review this project'
assert_last 'terminal arg=--app-id=org.omarchy.agent arg=agy arg=--dangerously-skip-permissions arg=--prompt-interactive arg=Review\ this\ project'
run_non_inline codex --prompt 'Review this project'
assert_last 'terminal arg=--app-id=org.omarchy.agent arg=codex arg=--approve-for-me arg=-- arg=Review\ this\ project'
run_non_inline grok --prompt 'Review this project'
assert_last 'terminal arg=--app-id=org.omarchy.agent arg=grok arg=--permission-mode arg=bypassPermissions arg=-- arg=Review\ this\ project'
run_non_inline omp --prompt 'Review this project'
assert_last 'terminal arg=--app-id=org.omarchy.agent arg=omp arg=--auto-approve arg=-- arg=Review\ this\ project'
run_inline copilot
